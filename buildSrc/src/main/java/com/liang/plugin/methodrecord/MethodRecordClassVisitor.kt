...
class MethodRecordClassVisitor(nextVisitor: ClassVisitor, private val className: String) : ClassVisitor(Opcodes.ASM9, nextVisitor) {
        ...
        val newMethodVisitor = object : AdviceAdapter(Opcodes.ASM9, methodVisitor, access, name, descriptor) {
                ...
                override fun onMethodEnter() {
                    ...
                    if (isNeedVisiMethod() && descriptor != null) {
                        ...
                        MethodRecordUtil.fillParameterArray(methodDesc, mv, parametersIdentifier, access)
