...
object MethodRecordUtil {
    ...
    fun getParameterTypeList(descriptor: String): List<String> {
        ...
        val m = Pattern.compile("(L.*?;|\\[{0,2}L.*?;|[ZCBSIFJD]|\\[{0,2}[ZCBSIFJD]{1})").matcher(descriptor.substring(0, descriptor.lastIndexOf(')') + 1))
        while (m.find()) {
    ...
    fun newParameterArrayList(mv: MethodVisitor, localVariablesSorter: LocalVariablesSorter): Int {
        ...
        mv.visitMethodInsn(AdviceAdapter.INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false)
    ...
    fun fillParameterArray(methodDesc: String, mv: MethodVisitor, parametersIdentifier: Int, access: Int) {
        ...
        methodType.argumentTypes.forEach {
            ...
            cursor += it.size
            mv.visitMethodInsn(AdviceAdapter.INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true)
    ...
    fun onMethodEnter(mv: MethodVisitor, className: String, name: String?, parametersIdentifier: Int) {
        mv.visitLdcInsn(className)
        mv.visitLdcInsn(name)
        mv.visitVarInsn(AdviceAdapter.ALOAD, parametersIdentifier)
        mv.visitMethodInsn(
            AdviceAdapter.INVOKESTATIC, "com/liang/androidagp/MethodRecorder", "onMethodEnter", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V", false
        )
    }

    fun onMethodExit(mv: MethodVisitor, className: String, name: String?, methodDesc: String) {
        val methodType = Type.getMethodType(methodDesc)
        ...
        mv.visitMethodInsn(AdviceAdapter.INVOKESTATIC, "com/liang/androidagp/MethodRecorder", "onMethodExit", "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false)
    }
